...
import { createGenero } from '../../store/slices/gender';
...
export const GeneroAdd = () => {
    ...
    const [data, setdata] = useState([])
      ...
      const EditAlertok = () => {
        ...
        position: 'top-center',
        icon: 'success',
        title: 'El Genero ' + data.nombre +' ha sido creado',
