...
import { EditGenero, FetchGeneroById } from '../../store/slices/gender';
...
export const GenderEdit = () => {
    ...
    const [data, setdata] = useState([])
      ...
      const dispatch = useDispatch();
        ...
        useEffect(() => {
          dispatch(FetchGeneroById(id));
        }, [dispatch])

        const { ById } = useSelector(state => state.genero);
      ...
      const EditAlertok = () => {
        ...
        position: 'top-center',
        icon: 'success',
        title: 'El Genero '+ data.nombre +' ha sido Editado',
