...
import { FetchGeneros, deleteGeneroId } from '../../store/slices/gender';
...
export const GenderList = () => {
    ...
    const filteredActor = listGenero.filter((data) => {
      console.log(data)
    ...
    const DeleteAlertok = () => {
        ...
        position: 'top-center',
        icon: 'success',
        title: 'El genéro ha sido Eliminado',
                          ...
                          <List>
                            {filteredActor.map((datos) => (
                              <ListItem key={datos.idPais}>
                                ...
                                <ListItemSecondaryAction>
                                  <Link to={`/Genero/edit/${datos.idGenero}`}>
                                    <IconButton
                                      color="primary"
                                    >
                                      <Edit />
                                  ...
                                  <IconButton
                                    color="error"
                                    onClick={() => handleDelete(datos.idGenero)}
                                  >
                                    <Delete />
                                  </IconButton>
                                </ListItemSecondaryAction>
