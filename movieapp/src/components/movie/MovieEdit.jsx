...
import { FetchMovieById, EditMovies } from '../../store/slices/movie';
...
export const MovieEdit = () => {
  ...
  const [requiredFields, setRequiredFields] = useState({
    ...
    const movieEditAlertok = () => {
      MySwal.fire({
      position: 'top-center',
      icon: 'success',
      title: 'La pelicula ha sido Editada',
  ...
  const movieEditAlert = () => {
    MySwal.fire({
      title: 'Estas seguro?',
      text: "Editaras información",
      icon: 'warning',
      ...
      dispatch(EditMovies(formValues))
      .then((result) => {
               ...
               {formValues.genero ? ( 
                ...
                <Grid item xs={12} sm={12} md={6}>
                                <Stack>
                                    ...
                                    <Select id="genero" name="genero" value={formValues.genero} onChange={handleInputChange}>
                ...
                <Grid item xs={12} sm={12} md={6}>
                                <Stack>
                                    ...
                                    <Select id="pais" name="pais" value={formValues.pais} onChange={handleInputChange}>
                                        {pais.map((option) => (
                ...
                <Grid item xs={12} sm={12} md={6}>
                                <Stack>
                                    ...
                                    <Select id="actor" name="actor" value={formValues.actor} onChange={handleInputChange}>
                                        {actors.map((option) => (
                ...
                <Grid item xs={12} sm={12} md={6}>
                                <Stack>
                                    ...
                                    <Select id="director" name="director" value={formValues.director} onChange={handleInputChange}>
              ...
              <Card>
                ...
                >
                  <CardMedia
                    ...
                    alt="Image"
                  />
                  <YouTubeEmbed videoId={formValues.codigoTrailer.split("youtu.be/")[1]} />
