...
import { EditPais, FetchPaisById } from '../../store/slices/country';
...
export const CountryEdit = () => {
    ...
    const [pais, setpais] = useState([])
      ...
      const dispatch = useDispatch();
        ...
        useEffect(() => {
          dispatch(FetchPaisById(id));
        }, [dispatch])

        const { ById } = useSelector(state => state.pais);
      ...
      const directorEditAlertok = () => {
        ...
        position: 'top-center',
        icon: 'success',
        title: 'El Actor' + pais.nombre +' ha sido Editado',
